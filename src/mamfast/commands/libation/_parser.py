...
def cmd_libation(args: argparse.Namespace) -> int:
    ...
    print_command_help(
        ...
        [
            ...
            ("mamfast libation scan --liberate", "Scan and download in one step"),
            ("mamfast libation liberate", "Download all pending audiobooks"),
            ("mamfast libation search 'query'", "Search your library"),
            ("mamfast libation guide", "Show detailed tutorial"),
        ],
    )
